...
import java.util.List;
    ...
    public class Controller {
        ...
        public ArrayList<String[]> ottieniCertificatiDaStaff() {
            StaffDAO staffDAO = new StaffImplementazionePostgresDAO();
            return staffDAO.getListaCertificatiCompleta();
        }

        public boolean inserisciCertificatoStaff(String cf, LocalDate nuovaScadenza, String nuovoPath) {
            StaffDAO staffDAO = new StaffImplementazionePostgresDAO();
            return staffDAO.inserisciCertificatoDaStaff(cf, nuovaScadenza, nuovoPath);
        }

        public boolean aggiornaScadenzaCertificatoStaff(String cf, LocalDate nuovaScadenza, String nuovoPath, String vecchioPath) {
            StaffDAO staffDAO = new StaffImplementazionePostgresDAO();
