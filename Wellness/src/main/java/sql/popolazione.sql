...
INSERT INTO staff(email, password, codicefiscale, nome, cognome, telefono, datanascita, via, civo, cap, iban, ruolo, qualifica) VALUES
...
INSERT INTO cliente(email, password, codicefiscale, nome, cognome, telefono, datanascita, via, civo, cap, stato_account) VALUES
